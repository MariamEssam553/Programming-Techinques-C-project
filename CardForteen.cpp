...
CardForteen::CardForteen(const CellPosition& pos) :Card(pos)
{
	cardNumber = 14;
	Owner = NULL;
}
void CardForteen::ReadCardParameters(Grid* pGrid)
{
...
void CardForteen::Apply(Grid* pGrid, Player* pPlayer)
{
